...
sa_lats <- c(-37, -27); sa_lons <- c(14, 34)
 ...
 plot1 <- ggplot() +#coord_equal() + 
  ...
  geom_point(data = site_list_sub, aes(x = lon, y = lat), alpha = 0.8, size = 1.6) +
 ...
 # Added in the bathy data but this is not needed for any of the analyses.
 # This just shows the bounding boxes 
```
