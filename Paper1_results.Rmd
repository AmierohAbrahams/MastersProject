...
wind_daily_sub <- wind_daily %>% 
  ...
  filter(site %in% selected_sites) # ***Does not detect Saldanha Bay???****
...
# Loading the data
load("Data_P1/MODIS_Chloro.RData") # Extracted chlorophyll data
